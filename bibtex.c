...
static text standardinput, standardoutput;
static integer poolsize;
static integer maxbibfiles;
static integer maxcites;
static integer wizfnspace;
static integer entstrsize;
static integer globstrsize;
static integer maxglobstrs;
static integer maxfields;
static integer litstksize;
static integer maxstrings;
static integer hashsize;
static integer hashprime;
static integer hashmax;
static integer endofdef;
static integer undefined;
static integer bad;
static  unsigned char history;
static  integer errcount;
static  ASCIIcode xord[256];
static  ASCIIcode xchr[256];
static  lextype lexclass[256];
static  idtype idclass[256];
static integer charwidth[256];
static  integer stringwidth;
 ASCIIcode *nameoffile;
integer namelength;
static  integer nameptr;
static  integer bufsize;
static  buftype buffer;
static bufpointer last;
static  buftype svbuffer;
static  bufpointer svptr1;
static bufpointer svptr2;
static  integer tmpptr, tmpendptr;
static  ASCIIcode *strpool;
static  poolpointer *strstart;
static  poolpointer poolptr;
static strnumber strptr;
static strnumber strnum;
static poolpointer pptr1, pptr2;
static hashpointer *hashnext;
static strnumber *hashtext;
static strilk *hashilk;
static integer *ilkinfo;
static integer hashused;
static boolean hashfound;
static hashloc dummyloc;
static strnumber sauxextension;
static strnumber slogextension;
static strnumber sbblextension;
static strnumber sbstextension;
static strnumber sbibextension;
static strnumber sbstarea;
static strnumber sbibarea;
static hashloc predefloc;
static integer commandnum;
static bufpointer bufptr1;
static bufpointer bufptr2;
static unsigned char scanresult;
static integer tokenvalue;
static integer auxnamelength;
static alphafile auxfile[auxstacksize + 1];
static strnumber auxlist[auxstacksize + 1];
static auxnumber auxptr;
static integer auxlnstack[auxstacksize + 1];
static strnumber toplevstr;
static alphafile logfile;
static alphafile bblfile;
static strnumber *biblist;
static bibnumber bibptr;
static bibnumber numbibfiles;
static boolean bibseen;
static alphafile *bibfile;
static boolean bstseen;
static strnumber bststr;
static alphafile bstfile;
static strnumber *citelist;
static citenumber citeptr;
static citenumber entryciteptr;
static citenumber numcites;
static citenumber oldnumcites;
static boolean citationseen;
static hashloc citeloc;
static hashloc lcciteloc;
static hashloc lcxciteloc;
static boolean citefound;
static boolean allentries;
static citenumber allmarker;
static integer bbllinenum;
static integer bstlinenum;
static hashloc fnloc;
static hashloc wizloc;
static hashloc literalloc;
static hashloc macronameloc;
static hashloc macrodefloc;
static fnclass *fntype;
static wizfnloc wizdefptr;
static wizfnloc wizfnptr;
static hashptr2 *wizfunctions;
static intentloc intentptr;
static integer *entryints;
static intentloc numentints;
static strentloc strentptr;
static ASCIIcode *entrystrs;
static strentloc numentstrs;
static integer strglbptr;
static strnumber *glbstrptr;
static ASCIIcode *globalstrs;
static integer *glbstrend;
static integer numglbstrs;
static fieldloc fieldptr;
static fieldloc fieldparentptr, fieldendptr;
static citenumber citeparentptr, citexptr;
static strnumber *fieldinfo;
static fieldloc numfields;
static fieldloc numpredefinedfields;
static fieldloc crossrefnum;
static boolean nofields;
static boolean entryseen;
static boolean readseen;
static boolean readperformed;
static boolean readingcompleted;
static boolean readcompleted;
static integer implfnnum;
static integer biblinenum;
static hashloc entrytypeloc;
static hashptr2 *typelist;
static boolean typeexists;
static boolean *entryexists;
static boolean storeentry;
static hashloc fieldnameloc;
static hashloc fieldvalloc;
static boolean storefield;
static boolean storetoken;
static ASCIIcode rightouterdelim;
static ASCIIcode rightstrdelim;
static boolean atbibcommand;
static hashloc curmacroloc;
static strnumber *citeinfo;
static boolean citehashfound;
static bibnumber preambleptr;
static bibnumber numpreamblestrings;
static integer bibbracelevel;
static integer *litstack;
static stktype *litstktype;
static litstkloc litstkptr;
static strnumber cmdstrptr;
static integer entchrptr;
static integer globchrptr;
static buftype exbuf;
static bufpointer exbufptr;
static bufpointer exbuflength;
static buftype outbuf;
static bufpointer outbufptr;
static bufpointer outbuflength;
static boolean messwithentries;
static citenumber sortciteptr;
static strentloc sortkeynum;
static integer bracelevel;
static hashloc bequals;
static hashloc bgreaterthan;
static hashloc blessthan;
static hashloc bplus;
static hashloc bminus;
static hashloc bconcatenate;
static hashloc bgets;
static hashloc baddperiod;
static hashloc bcalltype;
static hashloc bchangecase;
static hashloc bchrtoint;
static hashloc bcite;
static hashloc bduplicate;
static hashloc bempty;
static hashloc bformatname;
static hashloc bif;
static hashloc binttochr;
static hashloc binttostr;
static hashloc bmissing;
static hashloc bnewline;
static hashloc bnumnames;
static hashloc bpop;
static hashloc bpreamble;
static hashloc bpurify;
static hashloc bquote;
static hashloc bskip;
static hashloc bstack;
static hashloc bsubstring;
static hashloc bswap;
static hashloc btextlength;
static hashloc btextprefix;
static hashloc btopstack;
static hashloc btype;
static hashloc bwarning;
static hashloc bwhile;
static hashloc bwidth;
static hashloc bwrite;
static hashloc bdefault;
#ifndef NO_BIBTEX_STAT
static hashloc bltinloc[numbltinfns + 1];
static integer executioncount[numbltinfns + 1];
static integer totalexcount;
static bltinrange bltinptr;
#endif /* not NO_BIBTEX_STAT */
static strnumber snull;
static strnumber sdefault;
static strnumber st;
static strnumber sl;
static strnumber su;
static strnumber *spreamble;
static integer poplit1, poplit2, poplit3;
static stktype poptyp1, poptyp2, poptyp3;
static poolpointer spptr;
static poolpointer spxptr1, spxptr2;
static poolpointer spend;
static poolpointer splength, sp2length;
static integer spbracelevel;
static bufpointer exbufxptr, exbufyptr;
static hashloc controlseqloc;
static boolean precedingwhite;
static boolean andfound;
static integer numnames;
static bufpointer namebfptr;
static bufpointer namebfxptr, namebfyptr;
static integer nmbracelevel;
static bufpointer *nametok;
static ASCIIcode *namesepchar;
static bufpointer numtokens;
static boolean tokenstarting;
static boolean alphafound;
static boolean doubleletter, endofgroup, tobewritten;
static bufpointer firststart;
static bufpointer firstend;
static bufpointer lastend;
static bufpointer vonstart;
static bufpointer vonend;
static bufpointer jrend;
static bufpointer curtoken, lasttoken;
static boolean usedefault;
static bufpointer numcommas;
static bufpointer comma1, comma2;
static bufpointer numtextchars;
static unsigned char conversiontype;
static boolean prevcolon;
static cinttype verbose;
static integer mincrossrefs;
...
//   auxfile[i] = 0;
// }
// memset(lexclass, 0 , sizeof(lextype) * 256);
// memset(idclass, 0 , sizeof(idclass) * 256);
// memset(charwidth, 0, sizeof(integer) * 256);
// memset(auxfile, 0, sizeof(alphafile) * (auxstacksize + 1));
// memset(auxlist, 0, sizeof(strnumber) * (auxstacksize + 1));
// memset(auxlnstack, 0, sizeof(integer) * (auxstacksize + 1));
// memset(bltinloc, 0, sizeof(hashloc) * (numbltinfns + 1));
// memset(executioncount, 0, sizeof(integer) * (numbltinfns + 1));
}
...
static void markfatal(void) { history = 3; }
...
static void bufferoverflow(void) {
  BIBXRETALLOCNOSET("buffer", buffer, ASCIIcode, bufsize, bufsize + BUFSIZE);
  BIBXRETALLOCNOSET("sv_buffer", svbuffer, ASCIIcode, bufsize,
                    bufsize + BUFSIZE);
  ...
  BIBXRETALLOCNOSET("name_tok", nametok, bufpointer, bufsize,
                    bufsize + BUFSIZE);
  BIBXRETALLOC("name_sep_char", namesepchar, ASCIIcode, bufsize,
               bufsize + BUFSIZE);
}
static boolean zbibinputln(alphafile f) {
  /* 15 */ register boolean Result;
  last = 0;
  if ((eof(f)))
    Result = false;
  else {
...
static void pooloverflow(void) {
  BIBXRETALLOC("str_pool", strpool, ASCIIcode, poolsize, poolsize + POOLSIZE);
}
...
static void auxerrprint(void) {
  {
    fprintf(logfile, "%s%ld%s", "---line ", (long)auxlnstack[auxptr],
            " of file ");
    fprintf(standardoutput, "%s%ld%s", "---line ", (long)auxlnstack[auxptr],
            " of file ");
  }
  printauxname();
  printbadinputline();
...
static void zcheckciteoverflow(citenumber lastcite) {
  if ((lastcite == maxcites)) {
    ...
    BIBXRETALLOCNOSET("entry_exists", entryexists, boolean, maxcites,
                      maxcites + MAXCITES);
    BIBXRETALLOC("cite_info", citeinfo, strnumber, maxcites,
                 maxcites + MAXCITES);
...
static void bstlnnumprint(void) {
  {
    ...
    fprintf(standardoutput, "%s%ld%s", "--line ", (long)bstlinenum,
            " of file ");
  }
  printbstname();
}
...
static void bstidprint(void) {
  if ((scanresult == 0)) {
    fprintf(logfile, "%c%c%s", '"', xchr[buffer[bufptr2]],
            "\" begins identifier, command: ");
    fprintf(standardoutput, "%c%c%s", '"', xchr[buffer[bufptr2]],
            "\" begins identifier, command: ");
...
static void bstleftbraceprint(void) {
  {
    ...
    fprintf(standardoutput, "%c%c%s", '"', xchr[123],
...
static void bstrightbraceprint(void) {
  {
    ...
    fprintf(standardoutput, "%c%c%s", '"', xchr[125],
            "\" is missing in command: ");
  }
}
...
static void biblnnumprint(void) {
  {
    ...
    fprintf(standardoutput, "%s%ld%s", "--line ", (long)biblinenum,
            " of file ");
  }
  printbibname();
}
...
static void zbiboneoftwoprint(ASCIIcode char1, ASCIIcode char2) {
  /* 10 */ {
    ...
    {
      fprintf(logfile, "%s%c%s%c%c", "I was expecting a `", xchr[char1],
              "' or a `", xchr[char2], '\'');
      fprintf(standardoutput, "%s%c%s%c%c", "I was expecting a `", xchr[char1],
              "' or a `", xchr[char2], '\'');
    }
    biberrprint();
    goto lab10;
...
static void bibfieldtoolongprint(void) {
  /* 10 */ {
    ...
    {
      fprintf(logfile, "%s%ld%s", "Your field is more than ", (long)bufsize,
              " characters");
      fprintf(standardoutput, "%s%ld%s", "Your field is more than ",
              (long)bufsize, " characters");
    }
    biberrprint();
    goto lab10;
  }
...
static void outputbblline(void) {
  /* 15 10 */ if ((outbuflength != 0)) {
    while ((outbuflength > 0))
      if ((lexclass[outbuf[outbuflength - 1]] == 1))
            ...
            if ((numentstrs == 0)) {
              ...
              while ((strentptr < (citeptr + 1) * numentstrs)) {
                ...
                while (
                  ...
                  {
                    putc(xchr[entrystrs[(strentptr) * (entstrsize + 1) +
                                        (entchrptr)]],
                         logfile);
                  }
...
#ifndef NO_BIBTEX_STAT
  {
    ...
    }
    {
      fprintf(logfile, "%s%ld%s%ld%s\n", "            ", (long)strptr,
              " strings with ", (long)strstart[strptr], " characters,");
    }
    bltinptr = 0;
    totalexcount = 0;
...
static void zstartname(strnumber filename) {
  poolpointer pptr;
  free(nameoffile);
  nameoffile = xmallocarray(ASCIIcode,
                            (strstart[filename + 1] - strstart[filename]) + 1);
  nameptr = 1;
...
static boolean zstreqbuf(strnumber s, buftype buf, bufpointer bfptr,
                         bufpointer len) {
...
hashloc zstrlookup(buftype buf, bufpointer j, bufpointer l, strilk ilk,
                   boolean insertit) {
  /* 40 45 */ register hashloc Result;
  integer h;
  hashloc p;
  bufpointer k;
  strnumber strnum;
...
static void zzinttoASCII(integer theint, buftype intbuf, bufpointer intbegin,
                  bufpointer *intend) {
...
boolean zfindcitelocsforthiscitekey(strnumber citestr) {
  ...
  lcciteloc = strlookup(exbuf, 0, (strstart[citestr + 1] - strstart[citestr]),
                        10, false);
  if ((hashfound))
    Result = true;
  else
...
static void zquicksort(citenumber leftend, citenumber rightend) {
  ...
  if ((rightend - leftend < 10)) {
    ...
    }
    {
      ...
      right = rightend;
      do {
        while ((lessthan(citeinfo[left], partition)))
          left = left + 1;
        while ((lessthan(partition, citeinfo[right])))
          right = right - 1;
        if ((left < right)) {
          swap(left, right);
          left = left + 1;
...
static void zzbuildin(pdstype pds, pdslen len, hashloc *fnhashloc,
               bltinrange bltinnum) {
...
boolean zscan1(ASCIIcode char1) {
  register boolean Result;
  bufptr1 = bufptr2;
  while (((buffer[bufptr2] != char1) && (bufptr2 < last)))
    bufptr2 = bufptr2 + 1;
  if ((bufptr2 < last))
    Result = true;
  else
...
boolean zscan1white(ASCIIcode char1) {
  register boolean Result;
  bufptr1 = bufptr2;
  while (((lexclass[buffer[bufptr2]] != 1) && (buffer[bufptr2] != char1) &&
          (bufptr2 < last)))
    bufptr2 = bufptr2 + 1;
  if ((bufptr2 < last))
    Result = true;
...
boolean zscan3(ASCIIcode char1, ASCIIcode char2, ASCIIcode char3) {
  ...
  bufptr1 = bufptr2;
  while (((buffer[bufptr2] != char1) && (buffer[bufptr2] != char2) &&
          (buffer[bufptr2] != char3) && (bufptr2 < last)))
    bufptr2 = bufptr2 + 1;
  if ((bufptr2 < last))
    Result = true;
  else
...
boolean scanwhitespace(void) {
  register boolean Result;
  while (((lexclass[buffer[bufptr2]] == 1) && (bufptr2 < last)))
    bufptr2 = bufptr2 + 1;
  if ((bufptr2 < last))
    Result = true;
  else
...
static void zscanfndef(hashloc fnhashloc) {
  ...
  while ((buffer[bufptr2] != 125)) {
    ...
    case 35: {
      ...
      { outtoken(logfile); }
      {
        fprintf(logfile, "%s%ld\n", " is an integer literal with value ",
                (long)tokenvalue);
      }
#endif /* TRACE */
      literalloc = strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 1, true);
      if ((!hashfound)) {
        fntype[literalloc] = 2;
      ...
      }
      {
        ...
        if ((singleptr == singlefnspace)) {
          BIBXRETALLOC("singl_function", singlfunction, hashptr2, singlefnspace,
                       singlefnspace + SINGLEFNSPACE);
        }
    ...
    case 34: {
      ...
      if ((!scan1(34))) {
        {
          fprintf(logfile, "%s%c%s", "No `", xchr[34],
                  "' to end string literal");
          fprintf(standardoutput, "%s%c%s", "No `", xchr[34],
                  "' to end string literal");
        }
        skiptokenprint();
        goto lab25;
  ...
  bufptr2 = bufptr2 + 1;
lab10:
  libcfree(singlfunction);
}
boolean eatbibwhitespace(void) {
  /* 10 */ register boolean Result;
  while ((!scanwhitespace())) {

    if ((!bibinputln(bibfile[bibptr]))) {
      Result = false;
      goto lab10;
    }
...
boolean scanbalancedbraces(void) {
  ...
  bibbracelevel = 0;
  if ((storefield)) {
    while ((buffer[bufptr2] != rightstrdelim))
      switch ((buffer[bufptr2])) {
      case 123: {
    ...
    if ((storefield)) {
      ...
      if ((storetoken)) {
        ...
        if ((exbufptr == 0)) {
          ...
          if (((lexclass[strpool[tmpptr]] == 1) && (tmpptr < tmpendptr))) {
            {
              if ((exbufptr == bufsize)) {
                bibfieldtoolongprint();
                goto lab10;
            ...
            tmpptr = tmpptr + 1;
            while (((lexclass[strpool[tmpptr]] == 1) && (tmpptr < tmpendptr)))
              tmpptr = tmpptr + 1;
          }
        }
        while ((tmpptr < tmpendptr)) {
    ...
    if ((atbibcommand)) {
      ...
      if ((fieldinfo[fieldptr] != 0)) {
        ...
        if (((ilkinfo[fieldnameloc] == crossrefnum) && (!allentries))) {
          ...
          lcciteloc =
              strlookup(outbuf, exbufxptr, exbufptr - exbufxptr, 10, true);
          if ((hashfound)) {
            citeloc = ilkinfo[lcciteloc];
            if ((ilkinfo[citeloc] >= oldnumcites))
              citeinfo[ilkinfo[citeloc]] = citeinfo[ilkinfo[citeloc]] + 1;
          } else {

            citeloc =
                strlookup(exbuf, exbufxptr, exbufptr - exbufxptr, 9, true);
            if ((hashfound))
              hashciteconfusion();
...
static void znamescanforand(strnumber poplitvar) {
  ...
  andfound = false;
  while (((!andfound) && (exbufptr < exbuflength)))
    switch ((exbuf[exbufptr])) {
    case 97:
    case 65: {
      exbufptr = exbufptr + 1;
      if ((precedingwhite)) {
        if ((exbufptr <= (exbuflength - 3))) {
          ...
          if (((exbuf[exbufptr] == 110) || (exbuf[exbufptr] == 78))) {
            ...
            if (((exbuf[exbufptr + 1] == 100) || (exbuf[exbufptr + 1] == 68))) {
...
boolean vontokenfound(void) {
  ...
  while ((namebfptr < namebfxptr))
    if (((svbuffer[namebfptr] >= 65) && (svbuffer[namebfptr] <= 90)))
      goto lab10;
    else if (((svbuffer[namebfptr] >= 97) && (svbuffer[namebfptr] <= 122))) {
      Result = true;
      goto lab10;
      ...
      if (((namebfptr + 2 < namebfxptr) && (svbuffer[namebfptr] == 92))) {
        ...
        while (
            ((namebfptr < namebfxptr) && (lexclass[svbuffer[namebfptr]] == 2)))
          namebfptr = namebfptr + 1;
        controlseqloc =
            strlookup(svbuffer, namebfyptr, namebfptr - namebfyptr, 14, false);
        if ((hashfound)) {
        ...
        while (((namebfptr < namebfxptr) && (nmbracelevel > 0))) {
          ...
          if (((svbuffer[namebfptr] >= 65) && (svbuffer[namebfptr] <= 90)))
            goto lab10;
          else if (((svbuffer[namebfptr] >= 97) &&
                    (svbuffer[namebfptr] <= 122))) {
            Result = true;
            goto lab10;
    ...
    while ((spptr < spend))
      if ((strpool[spptr] == 123)) {
        ...
        spptr = spptr + 1;
        {
          ...
          endofgroup = false;
          tobewritten = true;
          while (((!endofgroup) && (spptr < spend)))
            if ((lexclass[strpool[spptr]] == 2)) {
              spptr = spptr + 1;
              {
                if ((alphafound)) {
                  ...
                  case 70: {
                    ...
                    if ((curtoken == lasttoken))
                      tobewritten = false;
                    if (((strpool[spptr] == 102) || (strpool[spptr] == 70)))
                      doubleletter = true;
                  } break;
                  case 118:
                  case 86: {
                    ...
                    if ((curtoken == lasttoken))
                      tobewritten = false;
                    if (((strpool[spptr] == 118) || (strpool[spptr] == 86)))
                      doubleletter = true;
                  } break;
                  case 108:
                  case 76: {
                    ...
                    if ((curtoken == lasttoken))
                      tobewritten = false;
                    if (((strpool[spptr] == 108) || (strpool[spptr] == 76)))
                      doubleletter = true;
                  } break;
                  case 106:
                  case 74: {
                    ...
                    if ((curtoken == lasttoken))
                      tobewritten = false;
                    if (((strpool[spptr] == 106) || (strpool[spptr] == 74)))
                      doubleletter = true;
                  } break;
                  default: {
                    bracelvloneletterscomplaint();
          ...
          if (((endofgroup) && (tobewritten))) {
            ...
            while ((spbracelevel > 0))
              if (((lexclass[strpool[spptr]] == 2) && (spbracelevel == 1))) {
                spptr = spptr + 1;
                {
                  if ((doubleletter))
                    spptr = spptr + 1;
...
#ifdef TRACE
    {
      fprintf(logfile, "%s%ld%s%ld\n", "Pointer is ", (long)strptr,
              " but should be ", (long)cmdstrptr);
...
static void addpoolbufandpush(void) {
  {
    while ((poolptr + exbuflength > poolsize))
      pooloverflow();
  }
  exbufptr = 0;
...
static void zaddoutpool(strnumber pstr) {
  ...
  pptr1 = strstart[pstr];
  pptr2 = strstart[pstr + 1];
  while ((outbuflength + (pptr2 - pptr1) > bufsize))
    bufferoverflow();
  ...
  while (((outbuflength > maxprintline) && (!unbreakabletail))) {
    ...
    breakptfound = false;
    while (((lexclass[outbuf[outbufptr]] != 1) && (outbufptr >= minprintline)))
      outbufptr = outbufptr - 1;
    if ((outbufptr == minprintline - 1)) {
      outbufptr = maxprintline + 1;
      while ((outbufptr < endptr))
        if ((lexclass[outbuf[outbufptr]] != 1))
          outbufptr = outbufptr + 1;
        else
          goto lab16;
    lab16:
      if ((outbufptr == endptr))
        ...
        breakptfound = true;
        while ((outbufptr + 1 < endptr))
          if ((lexclass[outbuf[outbufptr + 1]] == 1))
            outbufptr = outbufptr + 1;
          else
            goto lab17;
      lab17:;
    ...
    if ((poplit2 >= cmdstrptr)) {
      ...
      if ((poplit1 >= cmdstrptr)) {
        ...
        if (((strstart[poplit1 + 1] - strstart[poplit1]) == 0))
          ...
          {
            while ((poolptr + (strstart[poplit1 + 1] - strstart[poplit1]) +
                        (strstart[poplit2 + 1] - strstart[poplit2]) >
                    poolsize))
              pooloverflow();
          }
          spptr = strstart[poplit2];
...
static void xgets(void) {
  ...
  else if (((!messwithentries) &&
            ((fntype[poplit1] == 6) || (fntype[poplit1] == 5))))
    bstcantmesswithentriesprint();
  else
    switch ((fntype[poplit1])) {
    case 5:
      if ((poptyp2 != 0))
        printwrongstklit(poplit2, poptyp2, 0);
      else
        entryints[citeptr * numentints + ilkinfo[poplit1]] = poplit2;
      break;
    case 6: {
      if ((poptyp2 != 1))
        printwrongstklit(poplit2, poptyp2, 1);
          ...
          if ((spend - spptr > globstrsize)) {
            {
              bst1printstringsizeexceeded();
              {
                ...
                fprintf(standardoutput, "%ld%s", (long)globstrsize,
                        ", the global");
              }
              bst2printstringsizeexceeded();
            }
...
static void xaddperiod(void) {
  ...
  lab15:
    ...
    default: {
      if ((poplit1 < cmdstrptr)) {
        {
          while ((poolptr + (strstart[poplit1 + 1] - strstart[poplit1]) + 1 >
                  poolsize))
            pooloverflow();
        }
        spptr = strstart[poplit1];
      ...
      while ((exbufptr < exbuflength)) {
        ...
        if ((exbuf[exbufptr] == 123)) {
          ...
          if ((conversiontype == 0)) {
            ...
            if ((exbufptr == 0))
              goto lab21;
            else if (((prevcolon) && (lexclass[exbuf[exbufptr - 1]] == 1)))
              goto lab21;
          }
          {
            exbufptr = exbufptr + 1;
            while (((exbufptr < exbuflength) && (bracelevel > 0))) {
              ...
              exbufxptr = exbufptr;
              while (((exbufptr < exbuflength) &&
                      (lexclass[exbuf[exbufptr]] == 2)))
                exbufptr = exbufptr + 1;
              controlseqloc =
                  strlookup(exbuf, exbufxptr, exbufptr - exbufxptr, 14, false);
              if ((hashfound)) {
                ...
                case 2:
                  ...
                  case 12: {
                    ...
                    exbufxptr = exbufxptr - 1;
                    while (((exbufptr < exbuflength) &&
                            (lexclass[exbuf[exbufptr]] == 1)))
                      exbufptr = exbufptr + 1;
                    tmpptr = exbufptr;
                    while ((tmpptr < exbuflength)) {

                      exbuf[tmpptr - (exbufptr - exbufxptr)] = exbuf[tmpptr];
                      tmpptr = tmpptr + 1;
                    }
...
static void xduplicate(void) {
  ...
  if ((poptyp1 != 1)) {
    ...
    if ((poplit1 < cmdstrptr))
      ...
      {
        while (
            (poolptr + (strstart[poplit1 + 1] - strstart[poplit1]) > poolsize))
          pooloverflow();
      }
      spptr = strstart[poplit1];
      spend = strstart[poplit1 + 1];
...
static void xformatname(void) {
  ...
  if ((poptyp1 != 1)) {
    ...
    addbufpool(poplit3);
    {
      ...
      if ((numnames < poplit2)) {
        if ((poplit2 == 1)) {
          ...
          fprintf(logfile, "%s%ld%s", "There aren't ", (long)poplit2,
                  " names in \"");
          fprintf(standardoutput, "%s%ld%s", "There aren't ", (long)poplit2,
                  " names in \"");
        }
    ...
    {
      {
        while ((exbufptr > exbufxptr))
          switch ((lexclass[exbuf[exbufptr - 1]])) {
          case 1:
          case 4:
            exbufptr = exbufptr - 1;
            break;
            ...
            if ((exbuf[exbufptr - 1] == 44)) {
              {
                ...
                fprintf(standardoutput, "%s%ld%s", "Name ", (long)poplit2,
                        " in \"");
              }
              printapoolstr(poplit3);
              {
      ...
      tokenstarting = true;
      while ((exbufxptr < exbufptr))
        switch ((exbuf[exbufxptr])) {
        case 44: {
          if ((numcommas == 2)) {
            {
              fprintf(logfile, "%s%ld%s", "Too many commas in name ",
                      (long)poplit2, " of \"");
              fprintf(standardoutput, "%s%ld%s", "Too many commas in name ",
                      (long)poplit2, " of \"");
            }
            printapoolstr(poplit3);
            {
              ...
              if ((exbuf[exbufptr + 1] == 92)) {
                ...
                while (((exbufptr < exbuflength) && (bracelevel > 0))) {
                  ...
                  while (((exbufptr < exbuflength) &&
                          (lexclass[exbuf[exbufptr]] == 2)))
                    exbufptr = exbufptr + 1;
                  controlseqloc = strlookup(exbuf, exbufyptr,
                                            exbufptr - exbufyptr, 14, false);
                  if ((hashfound)) {
...
static void xsubstring(void) {
  ...
  if ((poptyp1 != 0)) {
    ...
    if (((poplit1 <= 0) || (poplit2 == 0) || (poplit2 > splength) ||
      ...
      {
        while ((poolptr + spend - spptr > poolsize))
          pooloverflow();
      }
      while ((spptr < spend)) {
...
static void xtype(void) {
  if ((!messwithentries))
    bstcantmesswithentriesprint();
  else if (((typelist[citeptr] == undefined) || (typelist[citeptr] == 0)))
    pushlitstk(snull, 1);
  else
    pushlitstk(hashtext[typelist[citeptr]], 1);
}
            ...
            if ((exbuf[exbufptr + 1] == 92)) {
              ...
              while (((exbufptr < exbuflength) && (bracelevel > 0))) {
                ...
                if (((exbufptr < exbuflength) && (exbufptr == exbufxptr)))
                  ...
                  controlseqloc = strlookup(exbuf, exbufxptr,
                                            exbufptr - exbufxptr, 14, false);
                  if ((hashfound)) {
                    switch ((ilkinfo[controlseqloc])) {
                    case 12:
                ...
                while (((exbufptr < exbuflength) && (bracelevel > 0) &&
                  ...
                  if ((exbuf[exbufptr] == 125))
                    ...
                    stringwidth = stringwidth + charwidth[exbuf[exbufptr]];
                  exbufptr = exbufptr + 1;
                }
              }
              exbufptr = exbufptr - 1;
            } else
              stringwidth = stringwidth + charwidth[123];
          } else
            stringwidth = stringwidth + charwidth[123];
        } else if ((exbuf[exbufptr] == 125)) {
...
static void zexecutefn(hashloc exfnloc) {
  ...
  case 0: {
    ;
#ifndef NO_BIBTEX_STAT
    executioncount[ilkinfo[exfnloc]] = executioncount[ilkinfo[exfnloc]] + 1;
#endif /* not NO_BIBTEX_STAT */
  ...
  case 4: {
    if ((!messwithentries))
      ...
      if ((fieldinfo[fieldptr] == 0))
        ...
        pushlitstk(fieldinfo[fieldptr], 1);
    }
  } break;
  case 5: {
    if ((!messwithentries))
      ...
      pushlitstk(entryints[citeptr * numentints + ilkinfo[exfnloc]], 0);
  } break;
  case 6: {
    if ((!messwithentries))
      bstcantmesswithentriesprint();
      ...
      exbufptr = 0;
      while ((entrystrs[(strentptr) * (entstrsize + 1) + (exbufptr)] != 127)) {

        exbuf[exbufptr] =
            entrystrs[(strentptr) * (entstrsize + 1) + (exbufptr)];
        exbufptr = exbufptr + 1;
      }
      exbuflength = exbufptr;
      addpoolbufandpush();
...
static void getthetoplevelauxfilename(void) {
  ...
  nameoffile = xmallocarray(ASCIIcode, 256);
  strcpy(stringcast(nameoffile + 1), inputfilename);
  auxnamelength = strlen(stringcast(nameoffile + 1));
  {
    if (((auxnamelength +
              (strstart[sauxextension + 1] - strstart[sauxextension]) >
          maxint) ||
         (auxnamelength +
              (strstart[slogextension + 1] - strstart[slogextension]) >
          maxint) ||
         (auxnamelength +
              (strstart[sbblextension + 1] - strstart[sbblextension]) >
          maxint))) {
    ...
    }
    {
      ...
      if ((namelength < 4) ||
          (strcmp(stringcast(nameoffile + 1 + namelength - 4), ".aux") != 0))
        addextension(sauxextension);
      else
        auxnamelength = auxnamelength - 4;
      auxptr = 0;
      if ((!kpseinnameok(stringcast(nameoffile + 1)) ||
           !bibopenin(&auxfile[auxptr], -1, stringcast(nameoffile + 1)))) {
      ...
      if ((!kpseoutnameok(stringcast(nameoffile + 1)) || !bibopenout(&logfile, stringcast(nameoffile + 1)))) {
        printf("this is the error2\n");
        samwrongfilenameprint();
        goto lab46;
      }
      namelength = auxnamelength;
      addextension(sbblextension);
      if ((!kpseoutnameok(stringcast(nameoffile + 1)) || !bibopenout(&bblfile, stringcast(nameoffile + 1)))) {
        printf("this is the error3\n");
        samwrongfilenameprint();
        goto lab46;
      }
    }
...
static void auxbibdatacommand(void) {
  ...
  while ((buffer[bufptr2] != 125)) {
    ...
    }
    {
      ...
      biblist[bibptr] =
          hashtext[strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 6, true)];
      if ((hashfound)) {
        {
      ...
      if ((!kpseinnameok(stringcast(nameoffile + 1)) ||
           !bibopenin(&bibfile[bibptr], kpsebibformat, stringcast(nameoffile + 1)))) {
        {
...
static void auxbibstylecommand(void) {
  ...
  {
    bststr = hashtext[strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 5, true)];
    if ((hashfound)) {
      ;
#ifdef TRACE
      printbstname();
    ...
    startname(bststr);
    if ((!kpseinnameok(stringcast(nameoffile + 1)) ||
         !bibopenin(&bstfile, kpsebstformat, stringcast(nameoffile + 1)))) {
      {
...
static void auxinputcommand(void) {
  ...
  }
  {
    ...
    auxlist[auxptr] =
        hashtext[strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 3, true)];
    if ((hashfound)) {
      {
    ...
    }
    {
      ...
      {
        fprintf(logfile, "%s%ld%s", "A level-", (long)auxptr,
                " auxiliary file: ");
        fprintf(standardoutput, "%s%ld%s", "A level-", (long)auxptr,
                " auxiliary file: ");
      }
      printauxname();
      auxlnstack[auxptr] = 0;
...
static void getauxcommandandprocess(void) {
  ...
  if ((!scan1(123)))
    goto lab10;
  commandnum =
      ilkinfo[strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 2, false)];
  if ((hashfound))
    switch ((commandnum)) {
    case 0:
      auxbibdatacommand();
...
static void bstfunctioncommand(void) {
  ...
  {{if ((buffer[bufptr2] != 123)){bstleftbraceprint();
  {
    {
      Fputs(logfile, "function");
      Fputs(standardoutput, "function");
...
}
{
  ...
  if ((buffer[bufptr2] != 34)) {
    {
      fprintf(logfile, "%s%c%s", "A macro definition must be ", xchr[34],
              "-delimited");
      fprintf(standardoutput, "%s%c%s", "A macro definition must be ", xchr[34],
              "-delimited");
    }
    {
      bsterrprintandlookforblankline();
  ...
  }
  {
    ...
    if ((!scan1(34))) {
      {
        fprintf(logfile, "%s%c%s", "There's no `", xchr[34],
                "' to end macro definition");
        fprintf(standardoutput, "%s%c%s", "There's no `", xchr[34],
                "' to end macro definition");
      }
      {
        bsterrprintandlookforblankline();
...
static void getbibcommandorentryandprocess(void) {
  ...
  }
  {
    ...
    lowercase(buffer, bufptr1, (bufptr2 - bufptr1));
    commandnum =
        ilkinfo[strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 12, false)];
    if ((hashfound)) {
      atbibcommand = true;
      switch ((commandnum)) {
      case 0: {
      ...
      case 1: {
        ...
        if ((buffer[bufptr2] != rightouterdelim)) {
          {
            fprintf(logfile, "%s%c%s", "Missing \"", xchr[rightouterdelim],
                    "\" in preamble command");
            fprintf(standardoutput, "%s%c%s", "Missing \"",
                    xchr[rightouterdelim], "\" in preamble command");
          }
          biberrprint();
          goto lab10;
        }
      ...
      case 2: {
        ...
        }
        {
          ...
          }
          {
            ...
            lowercase(buffer, bufptr1, (bufptr2 - bufptr1));
            curmacroloc =
                strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 13, true);
      ...
      entrytypeloc = strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 11, false);
  ...
  }
  {
      ...
      ;
    {
      ...
      if ((allentries))
        ...
        lcciteloc = strlookup(exbuf, bufptr1, (bufptr2 - bufptr1), 10, false);
      if ((hashfound)) {
        entryciteptr = ilkinfo[ilkinfo[lcciteloc]];
        {
          if (((!allentries) || (entryciteptr < allmarker) ||
            ...
            if ((typelist[entryciteptr] == 0)) {
              {
                if (((!allentries) && (entryciteptr >= oldnumcites))) {
                  citeloc =
                      strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 9, true);
                  if ((!hashfound)) {
                    ilkinfo[lcciteloc] = citeloc;
          ...
          } else if ((!entryexists[entryciteptr])) {
            {
              ...
              lowercase(exbuf, 0,
                        (strstart[citeinfo[entryciteptr] + 1] -
                         strstart[citeinfo[entryciteptr]]));
              lcxciteloc = strlookup(exbuf, 0,
                                     (strstart[citeinfo[entryciteptr] + 1] -
                                      strstart[citeinfo[entryciteptr]]),
                                     10, false);
              if ((!hashfound))
    ...
    while ((buffer[bufptr2] != rightouterdelim)) {
        ...
        goto lab15;
      {
        ...
        if ((storeentry)) {
          lowercase(buffer, bufptr1, (bufptr2 - bufptr1));
          fieldnameloc =
              strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 11, false);
          if ((hashfound)) {
...
static void bstreadcommand(void) {
  ...
  }
  {
      ...
      if (verbose) {
        {
          fprintf(logfile, "%s%ld%s", "Database file #", (long)bibptr + 1,
                  ": ");
          fprintf(standardoutput, "%s%ld%s", "Database file #",
                  (long)bibptr + 1, ": ");
        }
        printbibname();
      } else {
...
#endif /* TRACE */
    {
      ...
      {
        entrystrs = xtalloc(
            (numentstrs + 1) * (numcites + 1) * (entstrsize + 1), ASCIIcode);
        strentptr = 0;
  ...
  while ((buffer[bufptr2] != 125)) {
    ...
    }
    {
      ...
      if ((numglbstrs == maxglobstrs)) {
        BIBXRETALLOCNOSET("glb_str_ptr", glbstrptr, strnumber, maxglobstrs,
...
static void getbstcommandandprocess(void) {
  ...
  lowercase(buffer, bufptr1, (bufptr2 - bufptr1));
  commandnum =
      ilkinfo[strlookup(buffer, bufptr1, (bufptr2 - bufptr1), 4, false)];
  if ((!hashfound)) {
    printatoken();
    {
      {
  ...
  while (hashprime < hashwant) {
    ...
    do {
      ...
      while ((n < o) && jprime) {
        ...
        while (hashtext[n] < j)
          hashtext[n] = hashtext[n] + 2 * hashnext[n];
        if (hashtext[n] == j)
          jprime = false;
        n = n + 1;
      }
...
//     ) )
//     {
//       printversionandexit ( "This is BibTeX, Version 0.99e" , "Oren
//       Patashnik" , nil , nil ) ;
//     }
//   } while ( ! ( getoptreturnval == -1 ) ) ;
//   if ( ( optind + 1 != argc ) )
//   {
//     fprintf ( stderr , "%s%s\n",  "bibtex" , ": Need exactly one file
//     argument." ) ; usage ( "bibtex" ) ;
//   }
// }
 void bibtexMainbody(void) {
  ...
  if (verbose) {
    {
      Fputs(logfile, "This is BibTeX, Version 0.99e");
      Fputs(standardoutput, "This is BibTeX, Version 0.99e");
    }
    {
      fprintf(logfile, "%s\n", versionstring);
      fprintf(standardoutput, "%s\n", versionstring);
  ...
  }
  {
    fprintf(logfile, "%s%ld%s%ld%s%ld\n",
            "Capacity: max_strings=", (long)maxstrings,
            ", hash_size=", (long)hashsize, ", hash_prime=", (long)hashprime);
  }
  if (verbose) {
    {
...
lab9998 : {
  ...
  if (((readperformed) && (!readingcompleted))) {
    {
      fprintf(logfile, "%s%ld%s", "Aborted at line ", (long)biblinenum,
              " of file ");
      fprintf(standardoutput, "%s%ld%s", "Aborted at line ", (long)biblinenum,
              " of file ");
    }
    printbibname();
  }
  ...
  //printf("Dont die without closing me please... %d\n", auxptr);
  if ((history > 1))
    uexit(history);
}